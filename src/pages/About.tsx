...
const ABOUT_HERO_IMAGE = "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop&w=1200&q=80";

export default function AboutUs() {
  return (
    <div className="min-h-screen bg-[#fdfbf7] text-[#1a2332]">
      {/* Breadcrumb */}
      <div className="max-w-4xl mx-auto px-4 py-3">
        <div className="flex items-center text-xs sm:text-sm text-gray-500">
          <Link to="/" className="hover:text-[#b58a4b] transition-colors">
            Home
          </Link>
      ...
      <section className="w-full py-10 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full bg-white border border-amber-100 rounded-3xl p-4 sm:p-6 shadow-xs">
            <AccordionItem value="consultant-mode" className="border-b last:border-b-0 border-amber-100">
              <AccordionTrigger className="py-4 text-base sm:text-lg font-serif font-semibold text-[#1a2332] hover:no-underline">
            ...
            <AccordionItem value="cash-in" className="border-b last:border-b-0 border-amber-100">
              <AccordionTrigger className="py-4 text-base sm:text-lg font-serif font-semibold text-[#1a2332] hover:no-underline">
                2. About Cash In
              </AccordionTrigger>
              <AccordionContent className="pb-5 text-xs sm:text-sm text-slate-600 leading-relaxed font-light">
            ...
            <AccordionItem value="frozen" className="border-b last:border-b-0 border-amber-100">
              <AccordionTrigger className="py-4 text-base sm:text-lg font-serif font-semibold text-[#1a2332] hover:no-underline">
                3. About Frozen
              </AccordionTrigger>
              <AccordionContent className="pb-5 text-xs sm:text-sm text-slate-600 leading-relaxed font-light">
                Promotion are not submitted after receiving an order will be in "Processing". All you need to do is sliding the "start" button to complete the outstanding Promotion.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="orders" className="border-b last:border-b-0 border-amber-100">
              <AccordionTrigger className="py-4 text-base sm:text-lg font-serif font-semibold text-[#1a2332] hover:no-underline">
                4. About Orders
              </AccordionTrigger>
              <AccordionContent className="pb-5 text-xs sm:text-sm text-slate-600 leading-relaxed font-light space-y-4">
                <div>
                  ...
                  <p className="mt-1">A Smart Falcon Order allows all Consultants to earn up to 3 times the Incentive.</p>
                </div>
                <div>
                  <strong>2. Premium Order</strong>
                  <p className="mt-1">A Premium Order offers 6x–7x profit opportunities on higher-value products.</p>
                </div>
                <div>
                  <strong>3. Luxury Order</strong>
                  <p className="mt-1">A Luxury Order appears when the snatching amount becomes significantly higher at VIP Level 5.</p>
                </div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
