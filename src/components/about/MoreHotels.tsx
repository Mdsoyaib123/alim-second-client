...
const ACCOR_HERO = "https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?auto=format&fit=crop&w=1000&q=80";
const MORE_SUB_1 = "https://images.unsplash.com/photo-1618773928121-c32242e63f39?auto=format&fit=crop&w=600&q=80";
const MORE_SUB_2 = "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=600&q=80";
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-md mb-3 h-80 sm:h-96 group">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex flex-col justify-end p-5">
            ...
            <div className="flex items-center space-x-2 bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-lg w-max mb-2">
              <span className="text-[#b58a4b] font-serif font-bold text-lg">A</span>
            ...
            <p className="text-slate-200 text-xs sm:text-sm font-light max-w-lg">
              Bespoke luxury stays, private villas, and personalized guest services worldwide.
            </p>
          </div>
        </div>
